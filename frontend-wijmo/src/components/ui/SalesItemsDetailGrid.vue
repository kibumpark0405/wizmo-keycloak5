<template>
    <div>
        ...
        >
            ...
            <wj-flex-grid-column binding="price" header="가격" width="2*" :isReadOnly="!editMode" align="center" />
            <wj-flex-grid-column binding="qty" header="수량" width="2*" :isReadOnly="!editMode" align="center" />
